      ...
      buttons: [
        ...
        },
        {
          ...
          onPress: async () => {
            ...
            await AsyncStorage.multiRemove(['user', 'accessToken', 'refreshToken', TOKEN_KEY]);
      ...
      items: [
        {
          ...
          subtitle: 'Referrals, applications, cashouts',
          onPress: () => navigation.navigate('AllActivities' as any),
        },
        {
          icon: Wallet,
          label: 'Earnings',
          subtitle: 'Commissions and cashouts',
    ...
    },
    {
      ...
      items: [
        { 
          ...
          subtitle: 'MoMo / payout details', 
          onPress: () => navigation.navigate('PaymentMethodSetup' as any),
        },
      ],
    },
    {
